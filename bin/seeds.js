// bin/seeds.js
require("dotenv").config(); // we need to get env file using require since bin/seeds.js is in NODEJS (not using EXpress)
// express flow: app.js -> export app -> server.js -> then env file
// 
